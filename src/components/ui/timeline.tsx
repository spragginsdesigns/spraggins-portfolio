  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-5xl mb-4 text-foreground max-w-4xl font-heading font-bold">
          My Journey
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-xl">
          From truck driver to Co-Founder & CTO. Here&apos;s the path that led me to building production systems at scale.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-cyan-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
